...
public class RmCharacterHomeEntity: Object {
    @Persisted(primaryKey: true) var id: Int64
    @Persisted var name: String
    @Persisted var sectionKey: String
    ...
    public static func map(order: Int, sectionName: String, item: RmCharacterModel) -> RmCharacterHomeEntity {
        let result = RmCharacterHomeEntity()
        result.id = item.id ?? 0
    ...
    public static func map(item: RmCharacterHomeEntity) -> RmCharacterModel {
